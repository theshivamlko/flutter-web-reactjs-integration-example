...
import 'package:flutter_common_module/models/models.dart';
import 'package:flutter_common_module/pages/pages.dart';
import 'package:flutter_common_module/providers/providers.dart';
    ...
    return Flexible(
      child: _groupChatId.isNotEmpty
          ? StreamBuilder<QuerySnapshot>(
              ...
              builder: (_, snapshot) {
                print("_buildListMessage ${snapshot.data}");
                if (snapshot.hasData) {
